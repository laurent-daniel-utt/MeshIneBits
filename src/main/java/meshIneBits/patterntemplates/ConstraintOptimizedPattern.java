...
import meshIneBits.artificialIntelligence.COAlgo2;
...
public class ConstraintOptimizedPattern extends PatternTemplate {
    @Override
    ...
    public Pavement pave(Layer layer) {
        try {
            ...
            COAlgo2 algorithm = new COAlgo2();
            Collection<Bit2D> bits = algorithm.getBits(
