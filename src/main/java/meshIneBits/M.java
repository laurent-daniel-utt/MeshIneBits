...
/**
 * Upgrade for the existing event notification with a map of tags, so that we can
 * know the event in detail.<br/>
 */
public class M {
    /**
     ...
     * @param valueMap Use {@link #map(Object...)} to create the value map from
     *                 couples of tag and object (tag placed before order)
     */
    ...
    /**
     * @param objects should have an even of args. If else, the last arg will be
     *                omitted. Elements at even position should be the tag, and
     *                ones at odd position should be the corresponding object
     ...
     * and the new {@link Bit3D} with tag {@link #NEW_BIT}
     */
    public static final String LAYER_MOVED_BIT = "layerMovedBit";

    /**
     * {@link #valueMap} should contains the collection of old {@link Bit3D}s with
     * tag {@link #OLD_BIT} and the collection of new {@link Bit3D} with tag
     * {@link #NEW_BIT}
     */
