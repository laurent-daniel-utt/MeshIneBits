...
/**
 * A DataLogEntry contains the data read or the data to write in the dataSet file. It contains the
 * position and orientation of a bit, and the section of its associated points.
 */
public class DataLogEntry {
   ...
   */
  public DataLogEntry(Vector2 bitPosition, Vector2 bitOrientation,
      Vector<Vector2> associatedPoints) {
