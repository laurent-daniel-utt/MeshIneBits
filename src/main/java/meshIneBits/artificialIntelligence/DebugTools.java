...
/**
 * DebugTools is useful for debugging. Was used with Genetics and NN Pavement.
 * <p>
 * Set its variables depending on what you want to draw, and call DebugTools.setPaintForDebug(true);
 * It will draw on the screen what is stored in the variables of DebugTools. You may have to modifiy
 * the method AIpaintForDebug in MeshWindowsCore to paint exactly what you need.
 *
...
public final class DebugTools {
  ...
  public static @NotNull Segment2D currentSegToDraw = new Segment2D(new Vector2(0, 0),
      new Vector2(0, 0));
  public static @NotNull Segment2D currentSegToDraw2 = new Segment2D(new Vector2(0, 0),
      new Vector2(0, 0));
