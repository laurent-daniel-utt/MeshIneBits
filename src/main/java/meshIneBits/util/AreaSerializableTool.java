...
//
//public class AreaSerializableTool {
//
//    /**
...
//
//
//    private static Vector2 compute2DPolygonCentroid(Layer.AreaSerializable area) {
//
...
//     */
//    public static Layer.AreaSerializable getAreaFrom(Polygon poly) {
//        if (poly == null)
//            return new Layer.AreaSerializable();
//        else
//            return new Layer.AreaSerializable(poly.toPath2D());
//    }
//
//    /**
...
//     */
//    public static Layer.AreaSerializable getAreaFrom(Shape2D shape) {
//        Layer.AreaSerializable resultArea = new Layer.AreaSerializable();
//        Vector<Layer.AreaSerializable> areas = getLevel0AreaSerializablesFrom(shape);
//        for (Layer.AreaSerializable a : Objects.requireNonNull(areas)) {
//            resultArea.add(a);
//        }
//        return resultArea;
//    }
...
//     */
//    public static Vector<Segment2D> getLargestPolygon(Layer.AreaSerializable area) {
//        Vector<Vector<Segment2D>> segments = AreaSerializableTool.getSegmentsFrom(area);
...
//     */
//    public static Vector<Layer.AreaSerializable> getLevel0AreaSerializablesFrom(Shape2D shape) {
//        Vector<Layer.AreaSerializable> areas = new Vector<>();
//        for (Polygon p : shape) {
...
//            return null;
//        } else {
//            return getLevel0AreaSerializablesFrom(areas);
//        }
//    }
//
//    /**
...
//     * @since 0.3
//     */
//    public static List<Layer.AreaSerializable> getContinuousSurfacesFrom(Shape2D shape) {
...
//     */
//    private static Vector<Layer.AreaSerializable> getLevel0AreaSerializablesFrom(Vector<Layer.AreaSerializable> areas) {
//
//        if (areas.isEmpty()) {
//            return null;
//        }
//
//        Vector<Vector<Layer.AreaSerializable>> areasByLevel = new Vector<>();
//        // We fill the vector with null values, it cannot have more levels than
//        // areas
//        for (@SuppressWarnings("unused")
//                Layer.AreaSerializable a : areas) {
...
//         */
//        int levelMax = 0;
//        for (Layer.AreaSerializable currentArea : areas) {
//            int levelCurrentArea = 0; // If level is even this area is filled,
//            // if it's odd this area is a hole
//            for (Layer.AreaSerializable otherArea : areas) {
//                if (!currentArea.equals(otherArea)) {
//                    Layer.AreaSerializable currentAreaClone = (Layer.AreaSerializable) currentArea.clone();
...
////		}
//
//        Vector<Layer.AreaSerializable> surfaces = new Vector<>();
//
...
//                continue;
//            }
//            Layer.AreaSerializable hole = new Layer.AreaSerializable();
...
//     * @since 0.3
//     */
//    private static List<Layer.AreaSerializable> getContinuousSurfacesFrom(List<Polygon> polygons) {
...
//        List<Layer.AreaSerializable> surfaces = new Vector<>();
...
//                        -> hole.add(AreaSerializableTool.getAreaFrom(p)));
//            // Dig the polygon in even level
//            for (Polygon p : classing.get(i)) {
//                Layer.AreaSerializable newSurface = AreaSerializableTool.getAreaFrom(p);
...
//     * @since 0.3
//     */
//    public static List<Layer.AreaSerializable> getContinuousSurfacesFrom(Layer.AreaSerializable area) {
...
//     */
//    public static List<Polygon> getPolygonsFrom(Layer.AreaSerializable area) {
...
//     */
//    public static Vector2 getLiftPoint(Layer.AreaSerializable area, double minRadius) {
//
//        // We check if the barycenter would be ok
//        Vector2 barycenter = AreaSerializableTool.compute2DPolygonCentroid(area);
...
//     */
//    public static Vector<Vector<Segment2D>> getSegmentsFrom(Layer.AreaSerializable area) {
...
//     */
//    public static Vector<Layer.AreaSerializable> segregateArea(Layer.AreaSerializable area) {
//
//        Vector<Vector<Segment2D>> polygons = AreaSerializableTool.getSegmentsFrom(area);
//        Vector<Layer.AreaSerializable> segregatedAreas = new Vector<>();
//
...
//                segregatedAreas.add(new Layer.AreaSerializable(path2D));
//        }
//        return AreaSerializableTool.getLevel0AreaSerializablesFrom(segregatedAreas);
//    }
//
//    /**
...
//     */
//    public static Layer.AreaSerializable expand(Layer.AreaSerializable area, Double width) {
...
//                .collect(Collectors.toList());
//        Layer.AreaSerializable finalArea = new Layer.AreaSerializable();
...
//     */
//    public static Polygon expand(Polygon polygon, Layer.AreaSerializable area, Double width) {
...
//    }
//
//    private static Segment2D translateOutward(Segment2D segment, Layer.AreaSerializable area, Double width) {
