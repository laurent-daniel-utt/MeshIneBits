...
//        System.out.println(point1.y > 0 ? calcAngleBetweenVectorAndAxeX(point1) * 180 / Math.PI : -calcAngleBetweenVectorAndAxeX(point1) * 180 / Math.PI);
  ...
  public Vector2 getTransformed(AffineTransform transfoMatrix) {
    ...
    Point2D.Double transformedPoint = (java.awt.geom.Point2D.Double) transfoMatrix.transform(point,
        null);
...
/*
   ...
   * vector. Note: if the length is smaller than 10^({@link meshIneBits.config.CraftConfig#errorAccepted
