...
/**
 * Contains a label and a text area, which receive multiple input.<br> Renders {@link
 * DoubleListParam}
 *
 * @author NHATHAN
 */
public class LabeledListReceiver extends Renderer {
  ...
  private static String msgInstruction =
      "<html>" + "<p>Please enter a new array of double values</p>"
          + "<p><small>Use " + delimiter
          + " to separate values and . to mark decimal point.</small></p>" + "</html>";
