...
class ProjectWindowZoomer extends JPanel {
  ...
  /**
   * Replica of {@link ProjectController#getZoom()} to simplify callee
   */
  ...
  private ProjectWindowCore projectWindowCore;

  ProjectWindowZoomer(ProjectController projectController, ProjectWindowCore core) {
    this.projectController = projectController;
    this.projectWindowCore = core;
    ...
    // Not show if project not sliced yet
    if (projectController.getMesh() == null || !(projectController.getMesh()
        .isSliced())) {
      setVisible(false);
    }
  }
  ...
  private void setZoom(double zoomValue) {
    ...
    projectController.setZoom(this.zoom);
  }
}