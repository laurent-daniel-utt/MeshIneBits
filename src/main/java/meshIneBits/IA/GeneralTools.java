...
public final class GeneralTools {
    ...
    /**
     * Find an approxiamtion of the intersection point between a segment and a circle
     ...
     * @param seg segment
     * @return an approxiamtion of the intersection point between the segment and the circle
     */
