...
public class DoubleListParam extends PatternParameter {
     ...
     * @param minValue     defines minimum of range of selection. Default =
     *                     {@link Double#MIN_VALUE}
     * @param maxValue     defines maximum of range of selection. Default =
    ...
    /**
     * @param minValue if {@link Double#isInfinite()} or {@link Double#isNaN()} holds
    ...
    /**
     * @param maxValue if {@link Double#isInfinite()} or {@link Double#isNaN()} holds
    ...
    /**
     * @param l contains default elements. Each element will be
     *          {@link #filter(Double)}
     */
     ...
     * {@link Double}
     *
     * @param newValue only accept {@link List} of {@link Double}s. Else, the current
