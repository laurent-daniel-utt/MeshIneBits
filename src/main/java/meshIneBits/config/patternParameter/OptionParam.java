...
public class OptionParam extends PatternParameter {
   ...
   * @param description  no constraint, but it should describe meaning of each option in
   *                     <tt>values</tt>
   * @param values       a list of choices. Must not be empty
   * @param defaultValue initial value of choice. If not present in <tt>values</tt>, it will take
   *                     the first element's value
   * @throws IllegalArgumentException if <tt>values</tt> is empty
   */
  public OptionParam(String name, String title, String description, List<String> values,
      String defaultValue)
