...
public class CraftConfig
{
	...
	@Setting(title = "Space between bits' widths (mm)",
			description = "Choose the gap between two consecutive bits' widths (mm)",
			minValue = 1.0, maxValue = 100.0,
			defaultValue = 5.0)
	public static double bitsWidthSpace = 5.0;
	
	@Setting(title = "Space between bits' lengths (mm)",
			description = "Choose the gap between two consecutive bits' lengths (mm)",
			minValue = 1.0, maxValue = 100.0,
			defaultValue = 1.0)
